package ru.learnup.rushmanov.mvc.spring.demo.app.controller;
...
import ru.learnup.rushmanov.mvc.spring.demo.app.service.OnlineSalesRegisterService;
...
public class OnlineSalesRegisterController {
    ...
    public String viewAllTickets (@RequestParam("perfName") String title, Model model){
